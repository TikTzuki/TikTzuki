---
title: MPC-based Crypto-Custody Design
tags: [cryptography, security, distributed-systems, consensus]
sidebar_position: 1
---

# MPC-based Crypto-Custody Design (Rust)

:::info[Merged design record]
This consolidates two earlier drafts — `MPC-Rust.mdx` and `mpc-cluster-ssd.md` — which
covered the same design with an identical section structure. Content is taken from the
fuller draft; headings, the Rust crate breakdown and the milestone plan from the cleaner
one. Citation tracking parameters have been stripped.
:::
...
Papers and reports kept alongside this design rather than linked offsite, since the
originals move:

- [GG18/GG19 threshold ECDSA (PDF)](/files/gg19-threshold-ecdsa.pdf) — the protocol family
  §1 weighs up.
- [Earlier MPC evaluation report, 2019-10-22 (PDF)](/files/mpc-report-2019-10-22.pdf) —
  superseded, kept for the reasoning it records.
...
[2]: https://github.com/ZenGo-X/multi-party-ecdsa "ZenGo-X/multi-party-ecdsa: Rust implementation of {t,n}"
[3]: https://crates.io/crates/async-nats "async-nats - crates.io: Rust Package Registry"
[4]: https://docs.rs/nats/latest/nats/struct.Options.html "Options in nats - Rust"
[5]: https://crates.io/crates/CGGMP24 "CGGMP24 - crates.io: Rust Package Registry"
[6]: https://github.com/axelarnetwork/tofn "axelarnetwork/tofn: A threshold cryptography library in Rust"
[7]: https://github.com/boltlabs-inc/tss-ecdsa "boltlabs-inc/tss-ecdsa: An implementation of a threshold ..."
[8]: https://docs.rs/k256 "k256 - Rust"
[9]: https://iqlusion.blog/k256-crate-pure-rust-projective-secp256k1-library "a pure Rust secp256k1 library based on projective formulas"
[10]: https://docs.rs/nats "nats - Rust"
[11]: https://github.com/tarcieri/rust-secp256k1-ecdsa-bench "Rust secp256k1 ECDSA benchmarks"
[12]: https://crates.io/crates/k256 "k256 - crates.io: Rust Package Registry"
